...
import { Table, Thead, Tbody, Tr, Th, Td, chakra, useDisclosure } from '@chakra-ui/react';
...
export function TodoDataTable<Data extends ITodo>({ data, columns }: DataTableProps<Data>) {
